...
driver.get('https://www.linkedin.com/in/rohitbhargava')
time.sleep(8)
...
more_exp=driver.find_element_by_xpath('//button[@class="pv-profile-section__card-action-bar pv-skills-section__additional-skills artdeco-container-card-action-bar"]')
more_exp.click()
...
for item in experience: 
    text = item.text 
    print(text)
ab_button = driver.find_element_by_xpath('//a[@href="#"]')
ab_button.click()     
...
about=driver.find_element_by_xpath("//span[@class='lt-line-clamp__raw-line']")
#print(skills.text)
